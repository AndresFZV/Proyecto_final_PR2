...
public class PanelAdminViewController {
    ...
    private PanelControlViewController panelControlViewController;

    @FXML
    void initialize() {
        vendedorController = new VendedorController();
        principalViewController = new PrincipalViewController();
        panelControlViewController = new PanelControlViewController();
        initView();
    ...
    private void agregarVendedor() {
        ...
        if (vendedorController.validarVendedorCedula(vendedorDto.cedula()) != null) {
        ...
        if (validarDatos(vendedorDto)) {
            ...
            if (vendedorController.crearVendedor(vendedorDto)) {
                ...
                panelControlViewController.agregarTabVendedor(vendedorDto.usuario().getNombreUsuario());
    ...
    public void setPanelControlViewController(PanelControlViewController panelControlViewController) {
        this.panelControlViewController = panelControlViewController;
    }
}